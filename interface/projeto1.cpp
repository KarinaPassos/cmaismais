...
projeto1::projeto1(QWidget *parent) :
...
void projeto1::resizeGL(int width, int height)
{
...
void projeto1::mousePressEvent(QMouseEvent *e){
...
void projeto1::initializeGL() {
    initializeOpenGLFunctions();
    glLineWidth(7);
}

void projeto1::paintGL(){
